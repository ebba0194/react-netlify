...
import Ambaum from '../assets/Ambaum.png'
import Anova from '../assets/Anova.png'
import Beekman from '../assets/Beekman.png'
import Biocidin from '../assets/Biocidin.png'
import Cloudpaper from '../assets/Cloudpaper.png'
import Dewey from '../assets/Dewey.png'
import EarthBreeze from '../assets/EarthBreeze.png'
import Forti from '../assets/Forti.png'
import Freedom from '../assets/Freedom.png'
import Hammerhead from '../assets/Hammerhead.png'
import HankyPanky from '../assets/HankyPanky.png'
import Hanz from '../assets/Hanz.png'
import Lobstergram from '../assets/Lobstergram.png'
import Luwa from '../assets/Luwa.png'
import Perigee from '../assets/Perigee.png'
...
export const projectData = [
    {
        ...
        logos: [
            ...
            { component: logos.FigmaLogo }, 
            { component: logos.JavascriptLogo }, 
        ]
    },
    {
        title: 'Luwa Luxury',
        url: 'https://luwaluxury.com/',
        content: '<p>TBD</p>',
        img: Luwa,
        logos: [
            { component: logos.ShopifyLogo },
    ...
    },
    {
        ...
        url: 'https://ultimatebarkcontrol.com/',
        content: '<p>TBD</p>',
        img: Ultimate,
        logos: [
            { component: logos.ShopifyLogo },
    ...
    {
        title: 'Freedom Hill Coffee',
        url: 'https://freedomhillcoffee.com/',
        content: '<p>TBD</p>',
        img: Freedom,
        logos: [
            { component: logos.ShopifyLogo},
    ...
    {
        title: 'The Singer Featherweight Shop',
    ...
    {
        title: 'Perigee Fund',
        url: 'https://perigeefund.org',
        content: '<p>TBD</p>',
        img: Perigee,
        logos: [
            { component: logos.WordpressLogo },
            { component: logos.SassLogo },
            { component: logos.FigmaLogo },
            { component: logos.JavascriptLogo }, 
        ]
    ...
    {
        title: 'Ambaum Labs',
        url: 'https://www.ambaum.com',
        content: '<p>TBD</p>',
        img: Ambaum,
        logos: [
            { component: logos.WordpressLogo },
            { component: logos.ReactLogo },
            { component: logos.GatsbyLogo },
            { component: logos.FigmaLogo },
        ]
    },
    {
